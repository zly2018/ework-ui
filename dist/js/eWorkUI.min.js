...
"use strict";function MenusService(e){return e("data/menus.json",{},{query:{method:"GET",params:{},isArray:!1}})}angular.module("ework-ui").factory("MenusService",["$resource",MenusService]);
...
function MasterCtrl(e,t,r,s){e.topMenus={},s&&(t.info("found service MenusService."),s.get({},function(r){t.info("found service result."),"false"==r.error&&(e.topMenus=r.menus,t.info("found service result."+r),$.each(e.topMenus,function(r,s){"true"==s.active&&(e.curSystem=s,t.info("menu active is "+s.name))}))})),e.selectSystem=function(t){e.curSystem.active="false",e.curSystem=t,e.curSystem.active="true","$state"==t.type&&r.go(t.value,{})}}angular.module("ework-ui").controller("MasterCtrl",["$scope","$log","$state","MenusService",MasterCtrl]);
