...
"use strict";angular.module("ework-ui").config(["$stateProvider","$urlRouterProvider",function(e,u){function a(u){if("$state"==u.type&&(l[u.value]||(l[u.value]={value:u.value,url:u.path,templateUrl:u.href},e.state(u.value,{url:u.path,templateUrl:u.href}))),u.menus||u.allMenus){var n=u.menus?u.menus:u.allMenus?u.allMenus:null;n&&$.each(n,function(e,u){a(u)})}}var l={};$.ajax({url:"data/menus.json",type:"GET",async:!1,dataType:"json",success:function(e,u){a(e),l=null},error:function(){}})}]);
"use strict";function ProjectService(e){return e("data/project.json",{},{query:{method:"GET",params:{},isArray:!1}})}function MenusService(e){return e("data/menus.json",{},{query:{method:"GET",params:{},isArray:!1}})}angular.module("ework-ui").factory("ProjectService",["$resource",ProjectService]),angular.module("ework-ui").factory("MenusService",["$resource",MenusService]);
...
function LeftNavCtrl(e,t,a,o){e.curNavSystem=null,e.selectNav=function(t){e.curNavSystem&&(e.curNavSystem.active="false"),e.curNavSystem=t,e.curNavSystem.active="true",t.menus&&t.menus.length&&(t.open?t.open=!1:t.open=!0),"$state"==t.type&&o.go(t.value,{})},e.isNavDown=!1,e.downNav=function(){e.isNavDown?e.isNavDown=!1:e.isNavDown=!0}}angular.module("ework-ui").controller("LeftNavCtrl",["$scope","$rootScope","$log","$state",LeftNavCtrl]);
function TopHeadCtrl(o,e,r,l){}angular.module("ework-ui").controller("TopHeadCtrl",["$scope","$rootScope","$log","MenusService",TopHeadCtrl]);
"use strict";function HelloWorldCtrl(l,e){l.message="Hello world!",l.hello=function(){e.query({},function(l){"false"==l.error&&alert(l.message)})}}angular.module("ework-ui").controller("HelloWorldCtrl",["$scope","HelloService",HelloWorldCtrl]);
function MasterCtrl(e,t,r,n,o){function u(){n.get({},function(t){"false"==t.error&&(e.project=t,$("title").text(e.project.name))})}e.topMenus={},o&&(t.info("found service MenusService."),o.get({},function(r){t.info("found service result."),"false"==r.error&&(e.topMenus=r.menus,t.info("found service result."+r),$.each(e.topMenus,function(r,n){"true"==n.active&&(e.curSystem=n,t.info("menu active is "+n.name))}))})),e.selectSystem=function(t){e.curSystem.active="false",e.curSystem=t,e.curSystem.active="true","$state"==t.type&&r.go(t.value,{})},u()}angular.module("ework-ui").controller("MasterCtrl",["$scope","$log","$state","ProjectService","MenusService",MasterCtrl]);
